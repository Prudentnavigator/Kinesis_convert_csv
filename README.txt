...
4. Select the Kinesis .csv file when prompted by entering its name, or type 'q' to quit 
    the script. 
5. The script will create a new .csv file named ``Kinesis_to_Koinly.csv`` or
